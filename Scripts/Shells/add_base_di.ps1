...
# ---------------- Domain ----------------
dotnet add "$SrcDir/Domain/Domain.csproj" package Ardalis.GuardClauses --version 6.0.0
...
# ---------------- Application ----------------
dotnet add "$SrcDir/Application/Application.csproj" package AutoMapper --version 13.0.1
dotnet add "$SrcDir/Application/Application.csproj" package AutoMapper.Extensions.Microsoft.DependencyInjection --version 13.0.1
dotnet add "$SrcDir/Application/Application.csproj" package FluentValidation --version 11.9.0
dotnet add "$SrcDir/Application/Application.csproj" package FluentValidation.DependencyInjectionExtensions --version 11.9.0
dotnet add "$SrcDir/Application/Application.csproj" package MediatR --version 12.2.0
...
dotnet add "$SrcDir/Infrastructure/Infrastructure.csproj" package MassTransit --version 9.0.0
dotnet add "$SrcDir/Infrastructure/Infrastructure.csproj" package MassTransit.EntityFrameworkCore --version 9.0.0
dotnet add "$SrcDir/Infrastructure/Infrastructure.csproj" package Microsoft.EntityFrameworkCore.Tools --version 9.0.0
dotnet add "$SrcDir/Infrastructure/Infrastructure.csproj" package Microsoft.Extensions.Configuration --version 9.0.0
dotnet add "$SrcDir/Infrastructure/Infrastructure.csproj" package Microsoft.Extensions.Configuration.Json --version 9.0.0
dotnet add "$SrcDir/Infrastructure/Infrastructure.csproj" package Microsoft.Extensions.Configuration.UserSecrets --version 9.0.0
dotnet add "$SrcDir/Infrastructure/Infrastructure.csproj" package Npgsql.EntityFrameworkCore.PostgreSQL --version 9.0.0
...
dotnet add "$SrcDir/Infrastructure/Infrastructure.csproj" package Serilog.Extensions.Logging --version 9.0.0
dotnet add "$SrcDir/Infrastructure/Infrastructure.csproj" package StackExchange.Redis --version 2.9.25

# ---------------- Api ----------------
dotnet add "$SrcDir/Api/Api.csproj" package MediatR --version 12.2.0
dotnet add "$SrcDir/Api/Api.csproj" package Microsoft.AspNetCore.Authentication.JwtBearer --version 9.0.0
dotnet add "$SrcDir/Api/Api.csproj" package Microsoft.AspNetCore.Mvc.Versioning --version 5.1.0
dotnet add "$SrcDir/Api/Api.csproj" package Microsoft.AspNetCore.OpenApi --version 9.0.0
dotnet add "$SrcDir/Api/Api.csproj" package Microsoft.EntityFrameworkCore.Design --version 9.0.0
dotnet add "$SrcDir/Api/Api.csproj" package Serilog.AspNetCore --version 9.0.0
dotnet add "$SrcDir/Api/Api.csproj" package Swashbuckle.AspNetCore --version 9.0.0
