...
{
    /// <inheritdoc />
    public partial class inti_migrate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "category_co_occurrence",
                schema: "ai",
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false, defaultValueSql: "gen_random_uuid()"),
                    category1 = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    category2 = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    co_occurrence_count = table.Column<int>(type: "integer", nullable: false, defaultValue: 1),
                    lift_score = table.Column<double>(type: "double precision", nullable: false, defaultValue: 1.0),
                    confidence_a_to_b = table.Column<double>(type: "double precision", nullable: false, defaultValue: 1.0),
                    confidence_b_to_a = table.Column<double>(type: "double precision", nullable: false, defaultValue: 1.0),
                    last_updated = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    category1_total_count = table.Column<int>(type: "integer", nullable: false, defaultValue: 1),
                    category2_total_count = table.Column<int>(type: "integer", nullable: false, defaultValue: 1),
                    total_sessions = table.Column<int>(type: "integer", nullable: false, defaultValue: 1),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_category_co_occurrence", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    last_updated = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    recommendation_count = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    click_through_count = table.Column<int>(type: "integer", nullable: false, defaultValue: 0),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true, defaultValueSql: "NOW()"),
                    created_by = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    modified_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    modified_by = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_category_embedding", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    recent_interactions = table.Column<int>(type: "integer", nullable: false),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true, defaultValueSql: "NOW()"),
                    created_by = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    modified_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    modified_by = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "ix_category_co_occurrence_category1_lookup",
                schema: "ai",
                table: "category_co_occurrence",
                column: "category1")
                .Annotation("Npgsql:IndexInclude", new[] { "category2", "lift_score", "co_occurrence_count" });

            migrationBuilder.CreateIndex(
                name: "ix_category_co_occurrence_category2_lookup",
                schema: "ai",
                table: "category_co_occurrence",
                column: "category2")
                .Annotation("Npgsql:IndexInclude", new[] { "category1", "lift_score", "co_occurrence_count" });

            migrationBuilder.CreateIndex(
                name: "ux_category_co_occurrence_category1_category2",
                schema: "ai",
                table: "category_co_occurrence",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_category_embedding_embedding",
                schema: "ai",
                table: "category_embedding",
                column: "embedding")
            ...
            migrationBuilder.CreateIndex(
                name: "ix_category_embedding_model_name",
                schema: "ai",
                table: "category_embedding",
                column: "model_name");

            migrationBuilder.CreateIndex(
                name: "ux_category_embedding_category",
                schema: "ai",
                table: "category_embedding",
                column: "category",
                unique: true);
