...
namespace AI.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260407064032_AddColumnSubscriptionExpiresAtUtc")]
    partial class AddColumnSubscriptionExpiresAtUtc
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Marketing.Domain.Entities.ExternalDistribution", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_external_distribution");

                    b.HasIndex("PostMarketingId")
                    ...
                    b.ToTable("external_distribution", "ai");
                });
            ...
            modelBuilder.Entity("Marketing.Domain.Entities.ExternalDistribution", b =>
                {
                    b.HasOne("Marketing.Domain.Entities.PostMarketing", null)
                        .WithMany("ExternalDistributions")
            ...
            modelBuilder.Entity("Marketing.Domain.Entities.PostMarketing", b =>
                {
                    b.Navigation("ExternalDistributions");
                });
