...
namespace Users.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260404165845_AddColumnFileUrlForPolicy")]
    partial class AddColumnFileUrlForPolicy
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Users.Domain.Entities.Policy", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("Type")
                        .HasDatabaseName("ix_policy_type");

                    b.ToTable("policy", "users");
                });
